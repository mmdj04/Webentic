import type { UiLibDoc, DesignSystemDoc } from 'contentlayer/generated'

type Doc = UiLibDoc | DesignSystemDoc
...
export function getBreadcrumbSegments(doc: Doc, prefix: string = '/docs'): BreadcrumbSegment[] {
  const segments: BreadcrumbSegment[] = [{ title: 'Docs', href: prefix }]
