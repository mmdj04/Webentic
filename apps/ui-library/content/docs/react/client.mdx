...
description: Webentic client for React Single Page Applications
---

## Installation

<BlockItem name="webentic-client-react" description="Webentic Client for React SPA" />

## Folder structure

<RegistryBlock itemName="webentic-client-react" />

## Usage

This block installs a Webentic client for connecting your React project to Supabase. It's designed for use in client-side components.
