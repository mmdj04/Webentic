---
title: Copywriting
description: A concise guide for writing UI copy in Webentic.
---
...
- **Webentic** (capitalize except in code)

## Formatting

- **Bold for emphasis** only when necessary
- **Inline code** for technical terms: `RLS`, `API key`, `webentic init`
