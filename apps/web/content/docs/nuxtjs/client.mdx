...
description: Webentic client for Nuxt.js
---

## Installation

<BlockItem name="webentic-client-nuxtjs" description="Webentic Client for Nuxt.js" />

## Folder structure

<RegistryBlock itemName="webentic-client-nuxtjs" />

## Usage

This block installs a Webentic client for connecting your Nuxt.js project to Supabase. It's designed to fully supports server-side rendering (SSR).

If you've already set up your Webentic client—either using the `npm create nuxt@latest` template or another method—you can continue using your existing setup.
...
<Callout type="warning" className="mt-4">
  {' '}
  This Webentic client is built for SSR with the Nuxt.js. If you're building a Vue SPA, use the [Vue
