...
description: Webentic client for Vue Single Page Applications
---

## Installation

<BlockItem name="webentic-client-vue" description="Webentic Client for Vue SPA" />

## Folder structure

<RegistryBlock itemName="webentic-client-vue" />

## Usage

This block installs a Webentic client for connecting your Vue project to Supabase. It's designed for use in client-side components.
