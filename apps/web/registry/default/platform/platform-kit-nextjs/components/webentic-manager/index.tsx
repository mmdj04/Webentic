...
import { LogoWebentic } from '@/registry/default/platform/platform-kit-nextjs/components/logo-webentic'
import { AuthManager } from '@/registry/default/platform/platform-kit-nextjs/components/webentic-manager/auth'
import { DatabaseManager } from '@/registry/default/platform/platform-kit-nextjs/components/webentic-manager/database'
import { LogsManager } from '@/registry/default/platform/platform-kit-nextjs/components/webentic-manager/logs'
import { SecretsManager } from '@/registry/default/platform/platform-kit-nextjs/components/webentic-manager/secrets'
import { StorageManager } from '@/registry/default/platform/platform-kit-nextjs/components/webentic-manager/storage'
import { SuggestionsManager } from '@/registry/default/platform/platform-kit-nextjs/components/webentic-manager/suggestions'
import { UsersManager } from '@/registry/default/platform/platform-kit-nextjs/components/webentic-manager/users'
import {
        ...
        <footer className="p-0 text-sm text-muted-foreground flex items-center gap-3 -m-3 border-t">
          <HoverCard>
            <HoverCardTrigger asChild>
              ...
              >
                <LogoWebentic size={16} />
                <span className="flex-1">Open in Webentic</span>
            ...
            >
              <h4 className="font-semibold mb-1">About Webentic</h4>
              <p className="text-muted-foreground">
...
export default function WebenticManagerDialog({
  projectRef,
  open,
  onOpenChange,
  isMobile,
